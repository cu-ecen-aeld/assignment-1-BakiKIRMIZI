...
void test_validate_my_username()
{
     ...
     */
    //TEST_ASSERT_TRUE_MESSAGE(false,"AESD students, please fix me!xd");
    
    const char* username_from_function = my_username();
    char* username_from_file = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(username_from_function, username_from_file, "The usernames do not match!");
